...
public interface PodGroupService {

    ResultDto<List<PodGroupInfo>> getPodGroupList(GetPodGroupListRequest request);

    ResultDto<PodGroupInfo> savePodGroup(PodGroup request);

    ResultDto<Integer> syncPodGroup();

    ResultDto<List<String>> getPodGroupNameList();
}
